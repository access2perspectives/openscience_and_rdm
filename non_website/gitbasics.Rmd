...
- ++ only changes are saved -> need less storage space <br> !! text files only, not binaries (.csv, .txt, .md but not .docs, .xlsx, .jpg,… files)

## git commit, principle

<center><img src="images/GitStructure.png" width="100%"" /></center>

## git commit, in Rstudio

<center><img src="images/commit_rstudio.png" width="100%"" /></center>
