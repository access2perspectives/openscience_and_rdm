...
Experimental design and p-hacking (reproducibility.html)
Presentation with example in between

#10:00-10:45

Reproducible research and data analysis I (documentation)
...
Reproducible research and data analysis II (using programs)
